...
while (t<=nT)
  ...
  'd dd_'sp'*1e9*3600'
  'cbar'
  'draw title dd_'sp' ug/hr/m2 'time':00, 'date
...
*  '!xli 'pic
  ...
  'set clevs .1 .2 .5 1 2 5 10 20 50 100 200'
  'set grads off'
  'd sum(dd_'sp', t=1, t='nT'))*3600*1e9'
  'cbar'
  'draw title dd_'sp', ug/m2 'time':00, 'date

   pic=outDir'/totdd_'sp'_'math_format("%03g",t)'.png'
  'printim 'pic' white x600 y800'
  say pic
  'c'
'quit'
